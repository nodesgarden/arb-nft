...
Current production mainnet config:

- active network: `arbitrum_mainnet`
- `NODE_NFT_MAINNET_CONTRACT_ADDRESS=0x1fc8184a57bD61eAC3dFBE53D8B2712195C9926f`
- `NODE_NFT_MAINNET_DEPLOYMENT_BLOCK=476087135`
- `NODE_NFT_MAINNET_MARKETPLACE_CONTRACT_ADDRESS=0x410b0037436d0b8468e1295dCbF3D86882ed6d7a`
- `NODE_NFT_MAINNET_MARKETPLACE_DEPLOYMENT_BLOCK=476087478`
- sync cursors initialized through block `476089311`
